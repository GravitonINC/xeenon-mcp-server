...
COPY scripts/xeenon-openapi.json /usr/local/scripts/
COPY --from=builder /usr/local/lib/node_modules/@graviton-inc/xeenon-mcp-server /usr/local/lib/node_modules/@graviton-inc/xeenon-mcp-server
